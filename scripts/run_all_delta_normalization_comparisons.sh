#!/bin/bash
#
# scripts/run_all_delta_normalization_comparisons.sh
# ==================================================
#
# This script automates the execution of the normalization comparison pipeline
# for DELTA embeddings across multiple RoBERTa layers.
#
...
BASE_INPUT_DIR="data/${DATASET_NAME}/embeddings/filtered/difference_embeddings"
...
for layer in "${LAYERS[@]}"; do
    ...
    python scripts/run_normalization_comparison_fixed.py \
        ...
        --delta_embeddings_dir "${BASE_INPUT_DIR}" \
        --output_dir "${BASE_OUTPUT_DIR}" \
        --layer_num "${layer}" \
        --normalization_types per_type all_but_mean \
        --filter_to_ec
