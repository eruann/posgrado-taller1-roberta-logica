#!/bin/bash
#
# scripts/run_all_delta_probes.sh
# ===============================
#
# This script automates the execution of the Decision Tree Probe across
# multiple RoBERTa layers and normalization strategies for DELTA embeddings.
